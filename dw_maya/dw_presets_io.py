...
def save_json(path: str, data: Dict[str, Any]) -> bool:
    ...
    :param data: Dictionary to be stored in JSON format.
...
def load_json(path: str) -> Optional[Dict[str, Any]]:
    ...
    :return: Loaded dictionary from the JSON file, or None if loading fails.
    """
...
def get_list_of_deformer_weights(deformer_list: List[str]) -> Dict[str, Dict]:
    ...
    for deformer in deformer_list:
        deformer_weights = getDeformerWeights(deformer)
