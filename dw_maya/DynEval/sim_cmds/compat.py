"""
DynEval/_compat.py — PySide2 / PySide6 compatibility layer

Single source of truth for API differences between the two versions.
All DynEval files should import Qt from here rather than directly.
...
Usage in any DynEval file
─────────────────────────
    from .._compat import (
        QtCore, QtGui, QtWidgets, Qt, Signal, Slot,
        wrapInstance, QShortcut, QAction, qt_exec,
    )
"""
