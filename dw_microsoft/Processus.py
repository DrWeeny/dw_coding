...
def EnumProcesses():
    ...
    for pid in pidProcess:
        ...
        if hProcess:
            ...
            processList.append("".join([ i for i in modname if i != '\x00']))#add by alexis BAUDOIN
...
def processusActive(nameProcessus):

    if nameProcessus in EnumProcesses():
        print nameProcessus, " is active"
        return True
    else:
        return False
    

def exit(nameProcessus):
    string = 'taskkill /f /im ' + nameProcessus
    os.system(string)